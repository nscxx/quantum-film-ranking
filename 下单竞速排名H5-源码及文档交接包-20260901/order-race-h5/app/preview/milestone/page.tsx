...
import { MILESTONE_DURATION_MS } from '@/lib/order-race/celebrations';

export default function MilestonePreview() {
  const [replay, setReplay] = useState(0);
  return <main style={{ position: 'fixed', inset: 0, background: '#02071d' }}>
    <MilestoneCelebration key={replay} event={{ durationMs: MILESTONE_DURATION_MS, milestone: 100, scoreAfter: 100, provinceName: '云南省' }} />
